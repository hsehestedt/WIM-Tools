...
$VersionInfo:FILEVERSION#=24,3,3,273
...
ProgramVersion$ = "24.3.3.273"
ProgramReleaseDate$ = "Mar 05, 2025"
...
Print " Help"
Locate 28, 0
Input "   Please make a selection by number (19 Exits from the program): ", MenuSelection
...
Print #ff, "echo you can use it to save the time needed to customize that file."
Print #ff, "echo."
...
Print #ff, ""
Print #ff, "CLS"
Print #ff, "echo If you need to add any drivers to Windows PE we can install them now. As an example, suppose that you have"
Print #ff, "echo a touchpad that will not work properly without drivers or a storage device that is not accessible unless"
Print #ff, "echo you load drivers. We will automatically add any drivers that you place on your desktop. The drivers must"
Print #ff, "echo placed into a folder called PE_Drivers in a structure like this:"
Print #ff, "echo."
...
For x = 1 To 2
    ...
    Print #ff, "echo."
    Print #ff, ""
    Print #ff, "echo [0] or [ENTER] Exit without selecting an answer file"
    Print #ff, ""
...
Print "file to bypass Windows 11 system requirements, notes you may need, etc."
Print
Print "Start by running ";: Color 0, 14: Print "Config_UFD.bat";: Color 15: Print " from ";: Color 0, 14: Print VolLabel$(2);: Color 15: Print "."
Print "This will configure your disk to boot the ISO image of your choosing. Note that you can also boot from the disk and"
Print "then select the ISO image to boot. This is helpful if you a system that you cannot boot into Windows."
Print
...
Print "   18) Exit                                                                                                     "
Color 0, 13
Print "   19) Get general help on the use of this program                                                              "
Color 0, 15
Print "   20) Exit help and return to main menu                                                                        "
Locate 28, 0
Color 15
Input "   Please select the item you would like help with by entering its number (20 returns to the main menu): ", MenuSelection
